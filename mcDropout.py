...
parser.add_argument('--models_dir', type=str, nargs='?', action='store', default='/output',
                    help='Where to save learnt weights and train vectors.')
parser.add_argument('--results_dir', type=str, nargs='?', action='store', default='/output',
                    help='Where to save learnt training plots. ')
...
trainset = datasets.MNIST(root='../data_mnist', train=True, download=True, transform=transform_train)
valset = datasets.MNIST(root='../data_mnist', train=False, download=True, transform=transform_test)
